...
@Tag(name = "Auth", description = "Autentifikatsiya, ro'yxatdan o'tish va email tasdiqlash")
public class AuthController {
    ...
    @PostMapping("/login")
    @Operation(summary = "Kirish (access + refresh token)")
    ...
    @PutMapping("/verify")
    @Operation(summary = "Email kodini tasdiqlash")
